      ...
      <Section class-name="px-0">
        ...
        <div class="flex flex-col lg:flex-row items-center lg:items-start lg:justify-between w-full">
          <SirCard size="md">
            ...
            <p>
              We are raising a small amount to pay for audits, deployment costs, initial liquidity and any other
              necessary
              expenses.
            </p>
            <p>
          ...
          <SirCard size="md">
            ...
            <p>SIR has no private sales, and no multiple rounds. Everyone is given the same chance at the same
              price.</p>
