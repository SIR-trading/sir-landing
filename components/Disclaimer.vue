    ...
    <Modal :is-visible="isModalOpen" @click="isModalOpen = false" @close="toggleModal">
      <div class="modal-content text-center md:text-left p-6 flex flex-col gap-3 text-[14px]">
        ...
        <p class="flex flex-col">
          <span class="underline">Trustless Launch:</span>
        ...
        <p class="flex flex-col">
          <span class="underline">Risk of Bugs and Attacks:</span>
       ...
       <p class="flex flex-col">
          <span class="underline">Value of Token SIR: </span>
       ...
       <p class="flex flex-col">
          <span class="underline">Not financial advice:</span>
        ...
        <p class="flex flex-col">
          <span class="underline">Legal Compliance:</span>
